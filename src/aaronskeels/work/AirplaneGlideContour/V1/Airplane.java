...
public class Airplane {
	...
	public double assumedGlideSpeed; //[m/s] Assumed forward velocity throughout glide
	...
	private double forwardAngleFromYDeg; //[deg]
	
	public Airplane(double forwardVeloVsDropVeloRatio, double assumedGlideSpeedKnots, double assumedMaxBankAngleDeg, double curX, double curY, double curHeight, double forwardAngleFromYDeg) {
		this.forwardVeloVsDropVeloRatio = forwardVeloVsDropVeloRatio;
		this.assumedGlideSpeed = assumedGlideSpeedKnots * (.51 + 4d/900d);
		this.assumedMaxBankAngleDeg = assumedMaxBankAngleDeg;
		this.x = curX;
		this.y = curY;
		this.height = curHeight;
		this.forwardAngleFromYDeg = forwardAngleFromYDeg;
	}
	...
	public double getForwardAngleFromYDeg() {
		return forwardAngleFromYDeg;
	}
	public double getX() {
		return x;
	}
	...
	public void updateForwardAngleFromYDeg(double deg) {
		forwardAngleFromYDeg = deg;
	}
