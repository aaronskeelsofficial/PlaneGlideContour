...
//					System.out.println(originalPlanePNG.getType() + " : " + BufferedImage.);
	...
	public void drawPlane(BufferedImage bi, Graphics2D g2d, int radius, double scale) {
		double x = this.x;
		double y = this.y;
		x *= scale;
		y *= -scale;
...
//		g2d.drawImage(getRotatedCopyOfPlane(), (int) (bi.getWidth()/2d - radius), (int) (bi.getHeight()/2d - radius), (int) (2d*radius), (int) (2d*radius), null);
		g2d.drawImage(getRotatedCopyOfPlane(), (int) (x - radius), (int) (y - radius), (int) (2d*radius), (int) (2d*radius), null);
	}
